...
/*----------------------------------------------------------------------------*/
  ...
  std::printf("Hello from Step_006!\n\n");
  std::printf("I go a small step furhter from Step_005 and in addition to\n");
  std::printf("copying the vectors to device, I actually set some values\n");
  std::printf("to them.\n");
