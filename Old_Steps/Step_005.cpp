...
/*----------------------------------------------------------------------------*/
  ...
  std::printf("Hello from Step_005!\n\n");
  std::printf("I go a small step furhter from Step_004 and in addition to\n");
  std::printf("copying the system matrix to the device, I also copy the\n");
  std::printf("two vectors; right hand side and unknown vector.\n");
  ...
  std::printf("- AMGX_vector_create           (new)\n");
  std::printf("- AMGX_vector_upload           (new)\n");
  std::printf("- AMGX_matrix_destroy\n");
  std::printf("- AMGX_vector_destroy          (new)\n");
  ...
  std::printf("- AMGX_vector_handle           (new)\n\n");
