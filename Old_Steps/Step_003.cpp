...
/*----------------------------------------------------------------------------*/
  ...
  std::printf("Hello from Step_003!\n\n");
  std::printf("I go a step furhter from Step_002.  I am compiled with the\n");
  std::printf("same libraries as Step_002, but I form a system matrix and\n");
  std::printf("right hand side and unknow vectors on the host.\n");
  std::printf("\nThe AMGX functions I am using are the same as in Step_002:\n");
