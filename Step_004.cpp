...
/*----------------------------------------------------------------------------*/
  ...
  std::printf("Hello from Step_004!\n\n");
  std::printf("I go a step furhter from Step_003 and in addition to forming\n");
  std::printf("system matrix and right hand side and unknow vectors on the\n");
  std::printf("host, I also copy them to AMGX's worskpace on the device.\n");
